...
CJsonObject& CJsonObject::operator=(const int value)
{
    ...
    if (pFocusData != NULL)
    {
        switch (pFocusData->type)
        {
        case cJSON_Int:
        {
            pFocusData->valueint = value;
            pFocusData->valuedouble = (double)value;
            break;
        }
        case cJSON_Object:
        {
            if(NULL == pFocusData->child)
            {
                pFocusData->type = cJSON_Int;
                pFocusData->valueint = value;
                pFocusData->valuedouble = (double)value;
            }
            break;
...
CJsonObject& CJsonObject::operator=(const double value)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
CJsonObject& CJsonObject::operator=(const std::string value)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    if (pFocusData != NULL)
    {
        ...
        case cJSON_String:
        {
            if(NULL != pFocusData->valuestring)
            {
                free(pFocusData->valuestring);
            }
            size_t len;
            char* copy;
            ...
            {
                memcpy(copy, value.c_str(), len);

            }
            pFocusData->valuestring = copy;
            break;
        }
        case cJSON_Object:
        {
...
int CJsonObject::IntValue()
{
    ...
    if(NULL != pFocusData)
    {
        ret = pFocusData->valueint;
    }
    return ret;
}
double CJsonObject::DoubleValue()
{
        cJSON *pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    if(NULL != pFocusData)
    {
        ret = pFocusData->valuedouble;
    }
    return ret;
}
std::string CJsonObject::StringValue()
{
        cJSON *pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    if(NULL != pFocusData)
    {
        if(pFocusData->valuestring != NULL)
        ret = pFocusData->valuestring;
    }
    return ret;
}
...
CJsonObject& CJsonObject::operator[](const std::string& strKey)
{
    ...
    if (iter == m_mapJsonObjectRef.end())
    {
        ...
        if (pJsonStruct == NULL)
        {
            ...
            CJsonObject* pJsonObject = NULL;
            if(pJsonStruct == NULL)
            {
                pJsonObject = new CJsonObject();
            }
            else
            {
                pJsonObject = new CJsonObject(pJsonStruct);
            }
